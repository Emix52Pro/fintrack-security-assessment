...
| **Descripción** |  |
| **Activos** |  |
| **Propiedad violada (CID)** |  |
| **Probabilidad** | [Baja/Media/Alta] — [justifícalo] |
| **Impacto** | [Bajo/Medio/Alto] — [justifícalo] |
| **Nivel** |  |
| **Escenario concreto** |  |
| **Control** |  |

**Nota de análisis:** [algo no obvio sobre este riesgo]

---

## R2 · [nombre]
[repite la estructura de R1]
...
[¿Cuáles atacas primero y por qué? Defiende el orden.]
